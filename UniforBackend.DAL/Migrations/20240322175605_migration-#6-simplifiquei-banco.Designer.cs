...
namespace UniforBackend.DAL.Migrations
{
    ...
    [Migration("20240322175605_migration-#6-simplifiquei-banco")]
    partial class migration6simplifiqueibanco
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UniforBackend.Domain.Models.Entities.Compra", b =>
                {
                    ...
                    b.HasOne("UniforBackend.Domain.Models.Entities.Item", "Item")
                        .WithOne()
                        .HasForeignKey("UniforBackend.Domain.Models.Entities.Compra", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
