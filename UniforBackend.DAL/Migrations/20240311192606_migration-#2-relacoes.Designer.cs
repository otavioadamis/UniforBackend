...
namespace UniforBackend.DAL.Migrations
{
    ...
    [Migration("20240311192606_migration-#2-relacoes")]
    partial class migration2relacoes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniforBackend.Domain.Models.Entities.Compra", b =>
                {
                    ...
                    b.Property<string>("CompradorId1")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("UniforBackend.Domain.Models.Entities.Compra", b =>
                {
                    b.HasOne("UniforBackend.Domain.Models.Entities.User", null)
                        .WithMany("Compras")
